...
- **GTFObins** – Linux bins (used for living off the land, execution and privilege escalation) https://gtfobins.org/ 
- **LOLdrivers** – Windows drivers used in BYOVD attacks - https://www.loldrivers.io/ 
- **LOLapps** – living off the land third party applications - https://lolapps-project.github.io/# 
- **FileSec** – Updated list of all extensions used by threat actors - https://filesec.io/ 
- **Mal API** – win32 APIs used in malware based on category - https://malapi.io/ 
